...
TODO: ATTENTION: Definir viscosité cinématique: $\nu = \mu/\rho$.  CHECK UNITÉS !!! Quelques valeurs typiques pour différents fluides à température ambiante :

\begin{center}
\begin{tabular}{|c|c|c|}
\hline
Fluide & $\nu$ (Pa$\cdot$s) & Conditions \\
\hline
Eau & $10^{-3}$ & 20$^\circ$C \\
\hline
...
On retrouve le fluide parfait pour  $\tau_{ij} = -p \delta_{ij}$, soit $\tensor{\tau} = -p \tensor{\delta}$.
