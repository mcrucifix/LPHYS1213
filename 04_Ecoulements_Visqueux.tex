...
\begin{itemize}
    \item Force de pression : $-\pi r^2 \od{p}{x} \dif x$.
    \item Force visqueuse : La contrainte de cisaillement $\tau_{rx} = \mu \od{u_x}{r}$ agit sur les surfaces interne et externe de l'anneau. La différence de force visqueuse est :
    \begin{displaymath}
...
\begin{displaymath}
0 = -\pi r^2 \od{p}{x} + 2\pi r \mu \od{}{r}\left( r \od{u_x}{r}\right).
\end{displaymath}
