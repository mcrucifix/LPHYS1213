...
\begin{itemize}
  \item $\Rey \lesssim 1$ : les termes d'advection sont dominés par les termes de viscosité. Ce sont les conditions de l'écoulement de Stokes tel que nous l'avons dérivé en section~\ref{sec:stokes} et dont nous avons fait l'hypothèse pour le \cindex{problème de sédimentation}.
