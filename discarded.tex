...
\end{itemize}
\todo[inline]{modifier. utiliser les termes stationnaires et reprendre l'équation d'Euler ( En appliquant la deuxième loi de Newton à cet élément, on obtient :)}
\begin{displaymath}
