...
Considérons un countour tracé dans domaine occupé par le fluide. 


TODO: integrale du gradient de pression : poussée d'archimède égale au poids du volume déplacé
TODO: raisonner sur le moment de force. On démontre la position centroïde du centre de poussée
TODO: illustrer avec bateau et intéret d'avoir un centre de poussée en dessous du centre de gravité. 

TODO: illustrer conséquence pour corps flottant
TODO: conséquence pour la fonte des glaces
TODO: donner l'exemple du densitomètre
...
\end{equation}
Le paramètrè de la courbe est cette fois $t_0$, et non $t$. 
...
\begin{figure}
  \includegraphics{Python/01_vortex_streamlines.pdf}
