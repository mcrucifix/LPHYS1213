...
\sum_i \rightarrow \rho \Dt{}\underbrace{\left(\frac{1}{2}u^2\right)}_{k}  &= \rho \u \cdot \grad \vpot + \u \cdot \Div \tensor{T}
  \end{split}
\end{displaymath}
...
\begin{equation}
  \pdt{\rho^\prime} + u \cdot \grad \rho^\prime + \rho_0 ( 1 + \\frac{\rho^\prime}{\rho_0} \Div \u
\end{equation}
...
\begin{equation}
  \left( 1 + \frac{\rho^\prime}{\rho_0} \right) \Dt{\u} = -\frac{1}{\rho}\grad p^\prime + \frac{\rho^\prime}{\rho_0} \grad \phi  + \nu \lapl \u. 
